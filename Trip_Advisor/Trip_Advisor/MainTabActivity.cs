...
namespace Trip_Advisor
{
    ...
    public class MainTabActivity : Activity
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
         ...
         {
            //new FirstFragment(emailFromSignIn),
             new ThirdFragment(emailFromSignIn,passwordFromSignIn,nameFromSignIn,ageFsromSignIn),
            new SecondFragment()
            ...
            AddTabToActionBar("Welcome"); // Third Tab
            AddTabToActionBar("Favourite");
            AddTabToActionBar("Places");
